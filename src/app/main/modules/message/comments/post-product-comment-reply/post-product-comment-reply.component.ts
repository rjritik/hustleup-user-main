...
@Component({
  selector: 'app-post-product-comment-reply',
  templateUrl: './post-product-comment-reply.component.html',
  styleUrls: ['./post-product-comment-reply.component.css']
})
export class PostProductCommentReplyComponent implements OnInit {
