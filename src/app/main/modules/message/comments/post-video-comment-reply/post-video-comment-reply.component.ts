...
@Component({
  selector: 'app-post-video-comment-reply',
  templateUrl: './post-video-comment-reply.component.html',
  styleUrls: ['./post-video-comment-reply.component.css']
})
export class PostVideoCommentReplyComponent implements OnInit {
