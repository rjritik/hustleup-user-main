...
@Component({
  selector: 'app-post-blog-comment-reply',
  templateUrl: './post-blog-comment-reply.component.html',
  styleUrls: ['./post-blog-comment-reply.component.css']
})
export class PostBlogCommentReplyComponent implements OnInit {
